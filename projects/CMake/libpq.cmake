...
if (ARES_LIBPQ_INCLUDE_DIRS)
  ...
  if (WIN32)
    ...
    elseif (MSVC)
      message(FATAL_ERROR "Compiling on Windows with MSVC, but ARES_LIBPQ_LIBPQ_INCLUDE_DIRS is not specified. Assuming no package system is available. Specify ARES_LIBPQ_INCLUDE_DIRS exlicitly")
    endif()
  else()
