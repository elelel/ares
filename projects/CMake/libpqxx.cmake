...
if (ARES_LIBPQXX_LIB)
  ...
  if (WIN32)
    ...
    elseif (MSVC)
      message(FATAL_ERROR "Compiling on Windows with MSVC, but ARES_LIBPQ_LIB is not specified. Assuming no package system is available. Specify ARES_LIBPQXX_LIB exlicitly (should point to libpq library)")
    endif()
  else()
...
if (ARES_LIBPQXX_INCLUDE_DIRS)
  ...
  if (WIN32)
    ...
    elseif (MSVC)
      message(FATAL_ERROR "Compiling on Windows with MSVC, but ARES_LIBPQXX_LIBPQXX_INCLUDE_DIRS is not specified. Assuming no package system is available. Specify ARES_LIBPQXX_INCLUDE_DIRS exlicitly")
    endif()
  else()
