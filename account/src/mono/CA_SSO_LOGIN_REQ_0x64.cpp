...
ares::account::mono::packet_handler<typename ares::packet::CA_SSO_LOGIN_REQ_0x64>::packet_handler(server& serv, session& sess, state& st) :
  network::handler::packet::base<packet_handler<packet::CA_SSO_LOGIN_REQ_0x64>, packet::CA_SSO_LOGIN_REQ_0x64, server, session, state>(serv, sess, st),
