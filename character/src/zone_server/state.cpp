...
void ares::character::zone_server::state::on_packet_processed() {
}
...
void ares::character::zone_server::state::dispatch_packet(const uint16_t packet_id, void* buf, std::function<void(void*)> deallocator) {
