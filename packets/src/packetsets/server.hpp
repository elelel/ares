...
#define ARES_PCK_ID_NAME(ID, NAME) ARES_PACKETSET_ID_NAME(server, ID, NAME)
    ...
    // Ares
    ARES_PCK_ID_NAME(0x4001, ARES_ZH_MAP_IDS_REQ);
    ARES_PCK_ID_NAME(0x4002, ARES_HZ_MAP_IDS);
    ARES_PCK_ID_NAME(0x4004, ARES_HA_AID_AUTH_REQ);
    ARES_PCK_ID_NAME(0x4005, ARES_AH_AID_AUTH_RESULT);
    ARES_PCK_ID_NAME(0x4006, ARES_ZH_CID_AUTH_REQ);
    ARES_PCK_ID_NAME(0x4007, ARES_HZ_CID_AUTH_RESULT);
    ARES_PCK_ID_NAME(0x4008, ARES_ZH_MAP_ID_LOADED);
