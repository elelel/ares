struct CH_MAKE_CHAR_0x67 {
  inline void emplace(const char* name,
                      ...
                      int16_t headPal,
                      int16_t head) {
    PacketType = packet_id::CH_MAKE_CHAR_0x67;
  ...
  explicit CH_MAKE_CHAR_0x67(const char* name,
                        const size_t name_sz,
                        uint8_t Str,
                        uint8_t Agi,
                        uint8_t Vit,
  ...
  explicit CH_MAKE_CHAR_0x67(const std::string& name,
                        uint8_t Str,
                        uint8_t Agi,
                        uint8_t Vit,
                        uint8_t Int,
